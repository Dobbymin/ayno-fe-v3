...
import { FiEye, FiThumbsUp, FiUser } from "react-icons/fi";

import styled from "@emotion/styled";

import defaultThumbnail from "@/shared/_assets/default_thumbnail.png";
...
export const FlowCard = ({ image, title, author, authorImage, likes, views, onClick }: Props) => {
